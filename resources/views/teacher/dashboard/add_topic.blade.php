                ...
                <div class="row form-group">
                    <div class="col-4">
                        ...
                        <select class="form-select" name="course" aria-label="Default select example">
                            <option selected>Select Course for add Topic</option>
                            @foreach($course as $my_course)
                            <option value="{{$my_course->id}}">{{$my_course->name}}</option>
                            @endforeach
                        </select>
                    </div>
                    <div class="col-4">
                    ...
                    <div class="col-4 mt-4">
                        <input type="submit" class="btn btn-success" value="Add Topic">
                    </div>
                </div>
            </form>
